...
OSC:Button("冻羊脚本"，function()
    local loader = "https://raw.github.com/OAO-Kamu/I/main/Loader.lua" loadstring(game:HttpGet(loader,true))()
end)
