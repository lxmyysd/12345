...
local Window = library:new("XM脚本")

local krx = Window:Tab("信息",'88338286679368')
local bin = krx:section("玩家信息",true)
local about = krx:section("作者信息",true)
local UI = krx:section("UI设置",true)

local Main = Window:Tab("主要",'88338286679368')
