...
local Window = OrionLib:MakeWindow({Name = "矢井凛(LXM）", HidePremium = false, SaveConfig = true,IntroText = "矢井凛Sinyoen中心启动", ConfigFolder = "矢井凛Sinyoen中心"})
...
Tab:AddParagraph("❤️矢井凛Sinyoen脚本❤️")
Tab:AddParagraph("本脚本主要更新通用和黑洞类")
Tab:AddParagraph("阿尔宙斯注入器可能用不了")
Tab:AddParagraph("作者游戏名落花雪")
Tab:AddParagraph("作者QQ3253549307")
Tab:AddParagraph("作者福QQ3623422062")
Tab:AddParagraph("Q群892140244")
...
Tab:AddButton({
  Name = "矢井凛Sinyoen黑洞脚本(第2种要输入玩家名字)",
  Callback = function()
...
local sound = Instance.new("Sound")
    sound.SoundId = "rbxassetid://7023828725"
...
local sound = Instance.new("Sound")
    sound.SoundId = "rbxassetid://5410084188"
    sound.Parent = game.Workspace
    sound:Play()    
    end
})
